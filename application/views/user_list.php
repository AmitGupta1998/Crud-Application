...
<head>
	...
	<title>WebEterno Crud Apllication</title>
...
<div class="container">
	...
	<div class="row">
		<div>
			...
			<span  class="pull-right"><a href="<?php echo base_url(); ?>index.php/users/login" class="btn btn-primary"><span></span>Login</a></span><br><br>
